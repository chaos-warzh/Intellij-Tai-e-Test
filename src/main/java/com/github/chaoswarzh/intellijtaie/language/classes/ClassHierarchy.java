...
public interface ClassHierarchy extends Indexer<JClass> {
     ...
     * otherwise, null.
     * @throws com.github.chaoswarzh.intellijtaie.util.AnalysisException if signature is invalid.
     */
    @Nullable
     ...
     * @throws com.github.chaoswarzh.intellijtaie.util.AnalysisException if given receiver type
