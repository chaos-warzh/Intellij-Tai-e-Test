...
package com.github.chaoswarzh.intellijtaie.util.collection;

import com.github.chaoswarzh.intellijtaie.util.TriFunction;
import com.github.chaoswarzh.intellijtaie.util.function.SSupplier;
...
public class MapMapTwoKeyMap<K1, K2, V> extends
    ...
    @Override
    protected Iterator<Entry<K1, K2, V>> entryIterator() {
        return new EntryIterator();
    }

    private final class EntryIterator implements Iterator<Entry<K1, K2, V>> {
