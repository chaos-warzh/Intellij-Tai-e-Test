...
public abstract class AbstractTwoKeyMap<K1, K2, V> implements
     ...
     */
    private transient Set<Entry<K1, K2, V>> entrySet;
    ...
    private final class EntrySet extends AbstractSet<Entry<K1, K2, V>> {
    ...
    protected abstract Iterator<Entry<K1, K2, V>> entryIterator();
