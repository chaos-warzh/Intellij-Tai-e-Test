...
import com.github.chaoswarzh.intellijtaie.ir.DefaultIR;
...
import com.github.chaoswarzh.intellijtaie.ir.proginfo.MemberRef;
...
import com.github.chaoswarzh.intellijtaie.util.collection.*;
import soot.Body;
import soot.Local;
...
class MethodIRBuilder extends AbstractStmtSwitch<Void> {
    ...
    private FieldAccess getFieldAccess(FieldRef fieldRef) {
        com.github.chaoswarzh.intellijtaie.ir.proginfo.FieldRef jfieldRef =
